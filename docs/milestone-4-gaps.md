...
| G-U4 | Transactions filters; the `oversell` write guard                 | G-U1       | done `3a8c69f`     |
| G-U5 | Liveness in the strip and Settings; `pack_in_use`; Refresh guard | G-U1       | done `81ffff4`     |
| G-U6 | The runbook absorbs the gaps (P6–P8 amended); stories ticked     | G-U3–G-U5  | done (this commit) |
